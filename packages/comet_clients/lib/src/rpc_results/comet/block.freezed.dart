...
class _$BlockIDImpl implements _BlockID {
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_hash), partSetHeader);
...
mixin _$Block {
  ...
  List<EvidenceData>? get evidence => throw _privateConstructorUsedError;
...
class _$BlockImpl implements _Block {
  _$BlockImpl(
      ...
      @JsonKey(name: 'evidence') final List<EvidenceData>? evidence,
  ...
  @JsonKey(name: 'data')
  final Data? data;
  final List<EvidenceData>? _evidence;
  @override
  @JsonKey(name: 'evidence')
  List<EvidenceData>? get evidence {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, header, data,
      const DeepCollectionEquality().hash(_evidence), lastCommit);
...
mixin _$Header {
  ...
  List<int>? get lastCommitHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'data_hash')
  List<int>? get dataHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'validators_hash')
  List<int>? get validatorsHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'next_validators_hash')
  List<int>? get nextValidatorsHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'consensus_hash')
  List<int>? get consensusHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'app_hash')
  List<int>? get appHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'last_results_hash')
  List<int>? get lastResultsHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'evidence_hash')
  List<int>? get evidenceHash => throw _privateConstructorUsedError;
  @JsonKey(name: 'proposer_address')
  List<int>? get proposerAddress => throw _privateConstructorUsedError;
    ...
    return _then(_$HeaderImpl(
      ...
      dataHash: freezed == dataHash
          ...
          : dataHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      validatorsHash: freezed == validatorsHash
          ? _value._validatorsHash
          : validatorsHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      nextValidatorsHash: freezed == nextValidatorsHash
          ? _value._nextValidatorsHash
          : nextValidatorsHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      consensusHash: freezed == consensusHash
          ? _value._consensusHash
          : consensusHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      appHash: freezed == appHash
          ? _value._appHash
          : appHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      lastResultsHash: freezed == lastResultsHash
          ? _value._lastResultsHash
          : lastResultsHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      evidenceHash: freezed == evidenceHash
          ? _value._evidenceHash
          : evidenceHash // ignore: cast_nullable_to_non_nullable
              as List<int>?,
      proposerAddress: freezed == proposerAddress
          ? _value._proposerAddress
          : proposerAddress // ignore: cast_nullable_to_non_nullable
              as List<int>?,
    ));
  }
...
class _$HeaderImpl implements _Header {
  _$HeaderImpl(
      ...
      @JsonKey(name: 'last_commit_hash') final List<int>? lastCommitHash,
      @JsonKey(name: 'data_hash') final List<int>? dataHash,
      @JsonKey(name: 'validators_hash') final List<int>? validatorsHash,
      @JsonKey(name: 'next_validators_hash')
      final List<int>? nextValidatorsHash,
      @JsonKey(name: 'consensus_hash') final List<int>? consensusHash,
      @JsonKey(name: 'app_hash') final List<int>? appHash,
      @JsonKey(name: 'last_results_hash') final List<int>? lastResultsHash,
      @JsonKey(name: 'evidence_hash') final List<int>? evidenceHash,
      @JsonKey(name: 'proposer_address') final List<int>? proposerAddress})
      : _lastCommitHash = lastCommitHash,
        _dataHash = dataHash,
        _validatorsHash = validatorsHash,
        _nextValidatorsHash = nextValidatorsHash,
        _consensusHash = consensusHash,
        _appHash = appHash,
        _lastResultsHash = lastResultsHash,
        _evidenceHash = evidenceHash,
        _proposerAddress = proposerAddress;
  ...
  final List<int>? _lastCommitHash;
  @override
  @JsonKey(name: 'last_commit_hash')
  List<int>? get lastCommitHash {
    final value = _lastCommitHash;
    if (value == null) return null;
    if (_lastCommitHash is EqualUnmodifiableListView) return _lastCommitHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _dataHash;
  @override
  @JsonKey(name: 'data_hash')
  List<int>? get dataHash {
    final value = _dataHash;
    if (value == null) return null;
    if (_dataHash is EqualUnmodifiableListView) return _dataHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _validatorsHash;
  @override
  @JsonKey(name: 'validators_hash')
  List<int>? get validatorsHash {
    final value = _validatorsHash;
    if (value == null) return null;
    if (_validatorsHash is EqualUnmodifiableListView) return _validatorsHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _nextValidatorsHash;
  @override
  @JsonKey(name: 'next_validators_hash')
  List<int>? get nextValidatorsHash {
    final value = _nextValidatorsHash;
    if (value == null) return null;
    if (_nextValidatorsHash is EqualUnmodifiableListView)
      return _nextValidatorsHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _consensusHash;
  @override
  @JsonKey(name: 'consensus_hash')
  List<int>? get consensusHash {
    final value = _consensusHash;
    if (value == null) return null;
    if (_consensusHash is EqualUnmodifiableListView) return _consensusHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
  ...
  final List<int>? _lastResultsHash;
  @override
  @JsonKey(name: 'last_results_hash')
  List<int>? get lastResultsHash {
    final value = _lastResultsHash;
    if (value == null) return null;
    if (_lastResultsHash is EqualUnmodifiableListView) return _lastResultsHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _evidenceHash;
  @override
  @JsonKey(name: 'evidence_hash')
  List<int>? get evidenceHash {
    final value = _evidenceHash;
    if (value == null) return null;
    if (_evidenceHash is EqualUnmodifiableListView) return _evidenceHash;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }

  final List<int>? _proposerAddress;
  @override
  @JsonKey(name: 'proposer_address')
  List<int>? get proposerAddress {
    final value = _proposerAddress;
    if (value == null) return null;
    if (_proposerAddress is EqualUnmodifiableListView) return _proposerAddress;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(value);
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._lastCommitHash, _lastCommitHash) &&
            const DeepCollectionEquality().equals(other._dataHash, _dataHash) &&
            const DeepCollectionEquality()
                .equals(other._validatorsHash, _validatorsHash) &&
            const DeepCollectionEquality()
                .equals(other._nextValidatorsHash, _nextValidatorsHash) &&
            const DeepCollectionEquality()
                .equals(other._consensusHash, _consensusHash) &&
            const DeepCollectionEquality().equals(other._appHash, _appHash) &&
            const DeepCollectionEquality()
                .equals(other._lastResultsHash, _lastResultsHash) &&
            const DeepCollectionEquality()
                .equals(other._evidenceHash, _evidenceHash) &&
            const DeepCollectionEquality()
                .equals(other._proposerAddress, _proposerAddress));
  }
  ...
  int get hashCode => Object.hash(
      ...
      time,
      lastBlockId,
      const DeepCollectionEquality().hash(_lastCommitHash),
      const DeepCollectionEquality().hash(_dataHash),
      const DeepCollectionEquality().hash(_validatorsHash),
      const DeepCollectionEquality().hash(_nextValidatorsHash),
      const DeepCollectionEquality().hash(_consensusHash),
      const DeepCollectionEquality().hash(_appHash),
      const DeepCollectionEquality().hash(_lastResultsHash),
      const DeepCollectionEquality().hash(_evidenceHash),
      const DeepCollectionEquality().hash(_proposerAddress));
...
abstract class _Header implements Header {
  factory _Header(
      ...
      @JsonKey(name: 'evidence_hash') final List<int>? evidenceHash,
      @JsonKey(name: 'proposer_address')
      final List<int>? proposerAddress}) = _$HeaderImpl;
...
abstract class _Data implements Data {
  factory _Data(
      {@JsonKey(name: 'txs') final List<List<int>>? txs,
      @JsonKey(name: 'hash') final List<int>? hash}) = _$DataImpl;
