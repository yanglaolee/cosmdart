...
mixin _$ResponseInfo {
  ...
  List<int>? get lastBlockAppHash => throw _privateConstructorUsedError;
...
class _$ResponseInfoImpl implements _ResponseInfo {
  _$ResponseInfoImpl(
      ...
      : _lastBlockAppHash = lastBlockAppHash;
  ...
  final List<int>? _lastBlockAppHash;
  @override
  @JsonKey(name: 'last_block_app_hash', includeIfNull: false)
  List<int>? get lastBlockAppHash {
    final value = _lastBlockAppHash;
    if (value == null) return null;
    if (_lastBlockAppHash is EqualUnmodifiableListView)
      return _lastBlockAppHash;
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._lastBlockAppHash, _lastBlockAppHash));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, data, version, appVersion,
      lastBlockHeight, const DeepCollectionEquality().hash(_lastBlockAppHash));
...
abstract class _ResponseInfo implements ResponseInfo {
  factory _ResponseInfo(
      ...
      @JsonKey(name: 'app_version', includeIfNull: false) final int? appVersion,
      @JsonKey(name: 'last_block_height', includeIfNull: false)
      final String? lastBlockHeight,
      @JsonKey(name: 'last_block_app_hash', includeIfNull: false)
      final List<int>? lastBlockAppHash}) = _$ResponseInfoImpl;
