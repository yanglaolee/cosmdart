/// 使用Dart实现的JSON-RPC 2.0客户端
/// CometBFT支持的RPC协议URI/HTTP JSONRPC/HTTP JSONRPC/WS
/// CometBFT支持的RPC协议详情：https://docs.cometbft.com/v0.38/rpc/#/
/// 
/// 本实现作为底层组件供上层调用与CometBFT节点RPC通信
/// 支持单次RPC调用，也支持批量调用
/// JSON-RPC 2.0规范：https://wiki.geekdream.com/Specification/json-rpc_2.0.html
