...
class ChainInfo {
  ...
  factory ChainInfo.fromMap(Map<String, dynamic> data) => ChainInfo(
  ...
  /// `dart:convert`
  ///
  /// Parses the string and returns the resulting Json object as [ChainInfo].
  factory ChainInfo.fromJson(String data) {
    return ChainInfo.fromMap(json.decode(data) as Map<String, dynamic>);
  }

  /// `dart:convert`
  ///
  /// Converts [ChainInfo] to a JSON string.
  String toJson() => json.encode(toMap());

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    if (other is! ChainInfo) return false;
