...
class _$PartSetHeaderImpl implements _PartSetHeader {
  _$PartSetHeaderImpl(
      {@JsonKey(name: 'total') this.total, @JsonKey(name: 'hash') this.hash});
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, total, hash);
...
abstract class _PartSetHeader implements PartSetHeader {
  factory _PartSetHeader(
      ...
      @JsonKey(name: 'hash') final String? hash}) = _$PartSetHeaderImpl;
